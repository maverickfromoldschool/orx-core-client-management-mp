...
export default defineConfig(({command, mode}) => {
  ...
  return {
    ...
    build: {
      ...
      lib: {
        entry: 'src/index.tsx',
        name: 'orx-core-pricing-webcomponent',
        formats: ['umd'],
        fileName: (format) => `orx-core-pricing-webcomponent.${format}.js`
      },
      outDir: '../../dist/packages/orx-core-pricing-webcomponent',
      emptyOutDir: true
    },
    plugins: [
      ...
      sizeLimitPlugin({
        maxSizeInKB: 1000,
        customSizeLimits: [{fileName: 'orx-core-pricing-webcomponent.umd.js', maxSize: 2000}],
        messageType: 'error'
      })
    ],
    define: {
