              ...
              <Box key={f.fieldKey}>
                ...
                {f.fieldType === 'text' ? (
                  ...
                  <FormControl fullWidth size="small">
                    {/* We render the field label as a separate caption above the control, so
                        avoid using the floating InputLabel inside the Select to prevent
                        duplicate labels appearing inside the input. Use displayEmpty and
                        renderValue to show the chosen option's label. */}
                    <Select
                      displayEmpty
