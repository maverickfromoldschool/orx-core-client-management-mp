...
export default defineConfig(({command, mode}) => {
  ...
  return {
    ...
    build: {
      ...
      lib: {
        entry: 'src/index.tsx',
        name: 'orx-core-products-webcomponent',
        formats: ['umd'],
        fileName: (format) => `orx-core-products-webcomponent.${format}.js`
      },
      outDir: '../../dist/packages/orx-core-products-webcomponent',
      emptyOutDir: true
    },
    plugins: [
      ...
      sizeLimitPlugin({
        maxSizeInKB: 1000,
        customSizeLimits: [{fileName: 'orx-core-products-webcomponent.umd.js', maxSize: 2000}],
        messageType: 'error'
      })
    ],
    define: {
