...
export default defineConfig(({command, mode}) => {
  ...
  return {
    ...
    build: {
      ...
      lib: {
        entry: 'src/index.tsx',
        name: 'orx-core-admin-settings-webcomponent',
        formats: ['umd'],
        fileName: (format) => `orx-core-admin-settings-webcomponent.${format}.js`
      },
      outDir: '../../dist/packages/orx-core-admin-settings-webcomponent',
      emptyOutDir: true
    },
    plugins: [
      ...
      sizeLimitPlugin({
        maxSizeInKB: 1000,
        customSizeLimits: [{fileName: 'orx-core-admin-settings-webcomponent.umd.js', maxSize: 2000}],
        messageType: 'error'
      })
    ],
    define: {
    ...
    resolve: {
      ...
      alias: {
        '@optum-rx-core/orx-core-client-shared': resolve(
          __dirname,
          '../orx-core-client-shared/src/breadcrumbs/index.tsx'
        )
      }
    }
  };
