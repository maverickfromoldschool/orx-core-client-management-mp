...
import {AddAccountingCodeFormData, GLAccountNumberEntry} from './AddAccountingCodeDialog.types';

interface GLAccountNumberTabProps {
  control: Control<AddAccountingCodeFormData>;
  errors: FieldErrors<AddAccountingCodeFormData>;
  watch: UseFormWatch<AddAccountingCodeFormData>;
  setValue: UseFormSetValue<AddAccountingCodeFormData>;
                ...
                <TableRow key={index}>
                  {editingIndex === index ? (
                    <>
                      ...
                      <TableCell>
                        <DatePicker
                          value={new Date(entry.effectiveDate)}
