...
// Main form schema for editing
export const editAccountingCodeSchema = z.object({
  id: z.string().optional(), // ID of the record being edited
  accountingCode: z
    .string()
...
export type EditAccountingCodeFormData = z.infer<typeof editAccountingCodeSchema>;

export interface EditAccountingCodeDialogProps {
  /**
   ...
   */
  onSubmit: (data: EditAccountingCodeFormData) => void | Promise<void>;

  /**
   * Data for the accounting code being edited (required)
   */
  data: EditAccountingCodeFormData;
