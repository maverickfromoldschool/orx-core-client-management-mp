...
export default defineConfig(({command, mode}) => {
  ...
  return {
    ...
    build: {
      ...
      lib: {
        entry: 'src/index.tsx',
        name: 'orx-core-client-management-webcomponent',
        formats: ['umd'],
        fileName: (format) => `orx-core-client-management-webcomponent.${format}.js`
      },
      outDir: '../../dist/packages/orx-core-client-management-webcomponent',
      emptyOutDir: true
    },
    plugins: [
      ...
      sizeLimitPlugin({
        maxSizeInKB: 1000,
        customSizeLimits: [{fileName: 'orx-core-client-management-webcomponent.umd.js', maxSize: 2000}],
        messageType: 'error'
      })
    ],
    define: {
