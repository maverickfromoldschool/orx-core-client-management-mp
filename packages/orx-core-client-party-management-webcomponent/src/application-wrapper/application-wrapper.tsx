...
import {OrxCoreClientManagement, useErrorEvent} from '@optum-rx-core/orx-core-client-party-management';
...
export const ApplicationWrapper = (props: ApplicationWrapperProps) => {
  ...
  const styleCache = createEmotionStyleCache({
    key: 'orx-core-client-management',
    container
  });
