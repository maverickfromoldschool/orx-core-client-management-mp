...
import {
  ...
  ErrorEventPayload
} from '@optum-rx-core/orx-core-client-party-management';
...
export function handleEvent(
  e: CustomEvent<OrxCoreClientManagementEvent>,
  actions: {
    routeAction?: RouteAction;
    analyticsAction?: AnalyticsAction;
    errorAction?: ErrorAction;
...
export function useGlobalEvents(props: GlobalEventsProps, _handleEvent = handleEvent) {
  ...
  const onEvent = (e: CustomEvent<OrxCoreClientManagementEvent>) => {
