...
export function init() {
  ...
  const OrxCoreClientManagement = r2wc<ApplicationWrapperProps>(ApplicationWrapper, {...options});

  // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
  customElements.define('orx-core-client-management', OrxCoreClientManagement);
}
